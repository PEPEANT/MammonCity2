const DIGGLE_SEARCH_ROUTE_REGISTRY = Object.freeze([
  Object.freeze({
    ...
    title: "프리미엄 차량 매물",
    body: "호박마켓 프리미엄 매물 탭으로 이동해 외제차와 고급 직거래 매물을 바로 확인합니다.",
    tags: ["호박마켓", "외제차", "프리미엄", "직거래"],
  }),
  Object.freeze({
    id: "market-homes",
    ...
    fallbackRoute: "playstore/home",
    title: "부동산 직거래 매물",
    body: "원룸과 오피스텔 같은 부동산 매물을 호박마켓 부동산 탭에서 바로 확인합니다.",
    tags: ["호박마켓", "부동산", "원룸", "오피스텔", "직거래"],
  }),
  Object.freeze({
    id: "market-lifestyle",
    keywords: ["휴대폰", "중고폰", "스마트폰", "정장", "옷", "가전", "냉장고"],
    appId: "market",
    route: "market/home",
    fallbackRoute: "playstore/home",
    title: "생활 중고거래",
    body: "중고폰, 정장, 생활 가전 같은 생활 매물을 호박마켓 홈에서 바로 확인합니다.",
    tags: ["호박마켓", "중고폰", "정장", "가전", "생활"],
  }),
  Object.freeze({
    id: "market-vehicles",
    ...
    fallbackRoute: "playstore/home",
    title: "이동수단 직거래 매물",
    body: "자전거, 오토바이, 중고차 매물을 호박마켓에서 바로 비교합니다.",
    tags: ["호박마켓", "차량", "오토바이", "자전거", "중고차"],
  }),
  Object.freeze({
    id: "market-home",
    keywords: ["호박", "호박마켓", "당근", "당큰", "직거래", "중고거래"],
    appId: "market",
    route: "market/home",
    fallbackRoute: "playstore/home",
    title: "호박마켓",
