      ...
      choices: [
        {
          ...
          result: [
            ...
            "이제 맥도날드 공고는 서빙보다 봇 케어 쪽으로 기울기 시작한다.",
          ],
          changes: {
            remove: ["mcd-counter", "mcd-kitchen"],
            add: ["robot_floor"],
            news: "맥도날드 오픈 공고가 줄고 서빙봇 케어 공고가 새로 떴다.",
          },
        },
        {
          ...
          result: [
            ...
            "다음부터는 사람이 서빙하던 공고 대신 봇 관리 공고가 더 먼저 보인다.",
          ],
          changes: {
            remove: ["mcd-counter", "mcd-kitchen"],
            add: ["robot_floor"],
            news: "서빙봇 도입으로 맥도날드 공고가 관리형 공고로 교체됐다.",
          },
        },
        {
          ...
          result: [
            ...
            "맥도날드 알바는 끝났고, 앱엔 서빙봇 케어 공고만 남는다.",
          ],
          changes: {
            remove: ["mcd-counter", "mcd-kitchen"],
            add: ["robot_floor"],
